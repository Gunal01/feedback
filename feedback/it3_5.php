...
<input type="submit" name="next" value="Log out" style="height:40px; width:100px; font-face:'Comic Sans MS'; font-size: larger; color: white; background-color:rgb(77, 144, 254); border: #808080" /> 
</form>
<div id="add_err2"></div>
</body>
</html>
...
<?php 
    if(isset($_POST['next'])){    
        ...
        echo "<script>window.top.location='logout.php'</script>";
    }
 ?>